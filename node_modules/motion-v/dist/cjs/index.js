...
const createUnitType$1 = /* @__NO_SIDE_EFFECTS__ */ (unit) => ({
...
function mixValues(target, follow, lead, progress2, shouldCrossfadeOpacity, isOnlyMember) {
  if (shouldCrossfadeOpacity) {
    target.opacity = mixNumber$2(0, lead.opacity ?? 1, easeCrossfadeIn(progress2));
    target.opacityExit = mixNumber$2(follow.opacity ?? 1, 0, easeCrossfadeOut(progress2));
  } else if (isOnlyMember) {
    target.opacity = mixNumber$2(follow.opacity ?? 1, lead.opacity ?? 1, progress2);
  }
